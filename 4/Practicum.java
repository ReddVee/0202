 ...
 class OrdersManager {
    ...
    String getMaxOrderCustomerName() {
        ...
        for (String name : customersOrders.keySet()){
            ArrayList<Double> OrderOneName= customersOrders.get(name);
            double MaxOrderOneName = 0;
             for (Double or : OrderOneName) {
                 MaxOrderOneName += or;
            }
             if(maxOrder < MaxOrderOneName){
                 maxOrder = MaxOrderOneName;
                 customerName = name;
             }
